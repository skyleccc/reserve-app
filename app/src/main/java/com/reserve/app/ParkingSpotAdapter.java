...
public class ParkingSpotAdapter extends RecyclerView.Adapter<ParkingSpotAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.firstHour.setText("First Hour  = " + spot.priceFirstHour);
        holder.exceeding.setText("Exceeding   = " + spot.priceExceeding);
        holder.perDay.setText("Per Day     = " + spot.pricePerDay);
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        TextView title, address, firstHour, exceeding, perDay;
        ImageView image;
        Button bookButton;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            firstHour = itemView.findViewById(R.id.first_hour);
            exceeding = itemView.findViewById(R.id.exceeding);
            perDay = itemView.findViewById(R.id.per_day);
